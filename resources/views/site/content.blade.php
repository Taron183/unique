                            ...
                            <div class="row">
                                <div class="col-lg-5 col-sm-7">
                                    <div class="top_left_cont zoomIn wow animated">
                                        ...
                                        <a href="{{route('page',array($page->alias))}}" class="read_more2">Read more</a>
                                    </div>
                                </div>
                        ...
                        <div class="inner_section">
                            <div class="row">
                                ...
                                <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                                    ...
                                    <div class="work_bottom"> <span>Want to know more..</span> <a href="{{ route('page', array($page->alias)) }}" class="contact_btn">Contact Us</a> </div>
                                </div>
