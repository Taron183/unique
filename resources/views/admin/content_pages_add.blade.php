<div class="wrapper container-fluid">
    {!! Form::open(['url'=>route('pagesAdd'), 'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
       ...
       <div class="form-group">
           ...
           <div class="col-xs-8">
               {!! Form::text('name',old('name'),['class'=>'form-control','placeholder'=>'Write a title page
']) !!}
           </div>
       </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('alias',old('alias'),['class'=>'form-control','placeholder'=>'Write a title alias
']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::textarea('text',old('text'),['id'=>'editor','class'=>'form-control','placeholder'=>'Write a title text
']) !!}
        </div>
    </div>
